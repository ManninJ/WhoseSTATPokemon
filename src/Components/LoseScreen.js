...
export default function LoseScreen({ prevScore, highScore, beatHighScore, onStartClick, onHomeClick }) {
    return (
        <div className="LoseScreen">
            <h3>Your score is:</h3>
            <h2>{prevScore}</h2>
            <h3>{beatHighScore ? "Congratulations! \n You beat your High Score!" : "Unfortunate, better luck next time."}</h3>
            <div className="Menu">
                <h3>Click Start to begin a new game or Home to return Home...</h3>
